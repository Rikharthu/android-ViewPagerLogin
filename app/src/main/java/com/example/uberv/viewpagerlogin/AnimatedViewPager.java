...
/**
 * Our custom {@link ViewPager} that doesn't respond to any touch events and changes the duration of a swipe
...
public class AnimatedViewPager extends ViewPager {
    ...
    private void postInitViewPager() {
        try {
            // Override default ViewPager's scroller property with reflection
